        ...
        <div class='row'>
            <div class="col-3">
                <div class="options">
                    ...
                    <div class="radioInput">
                        <input class="form-check-input" type="radio" name="sortOptions" id="likes" value="likes"
                            v-model="searchParam" checked><label class="form-check-label" for="likes">Popularity</label>
                    </div>
                    <div class="radioInput">
                        <input class="form-check-input" type="radio" name="sortOptions" id="preparationTime"
                            value="preparationTime" v-model="searchParam"><label class="form-check-label"
                            for="preparationTime">Cook Time</label>
                    </div>
                    <div class="radioInput">
                        <input class="form-check-input" type="radio" name="sortOptions" id="publishDate"
                            value="publishDate" v-model="searchParam"><label class="form-check-label"
                            for="publishDate">Date Published</label>
                    </div>

                    <br>
                    <h3>Order:</h3>
                    <div class="radioInput">
                        <input class="form-check-input" type="radio" name="orderOptions" id="ascending" value="asc"
                            v-model="searchOrder"><label class="form-check-label" for="ascending">Ascending</label>
                    </div>
                    <div class="radioInput">
                        <input class="form-check-input" type="radio" name="orderOptions" id="descending" value="desc"
                            v-model="searchOrder" checked><label class="form-check-label"
            ...
            <div class="col-9">
                <div class="input-group" id="searchBar">
                    <button @click="startSearch()" class="btn btn-primary" id="searchButton"
